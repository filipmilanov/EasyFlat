...
import {
    ItemCreateComponent,
    ItemCreateEditMode
} from "./components/digital-storage/item-create/item-create.component";
...
const routes: Routes = [
  ...
  {path: 'digital-storage', children: [
      ...
      {path: 'item', children: [
          {path: 'create', component: ItemCreateComponent, data: {mode: ItemCreateEditMode.create}},
          {path: ':id/edit', component: ItemCreateComponent, data: {mode: ItemCreateEditMode.edit}},
