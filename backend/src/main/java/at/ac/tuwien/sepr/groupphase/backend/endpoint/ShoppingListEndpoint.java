...
public class ShoppingListEndpoint {
    ...
    public ShoppingItemDto createShoppingItem(@RequestBody ShoppingItemDto itemDto) throws ValidationException, ConflictException, AuthenticationException {
    ...
    @Secured("ROLE_USER")
    @GetMapping("{itemId}")
    public Optional<ShoppingItemDto> getShoppingItemById(@PathVariable Long itemId, @RequestHeader("Authorization") String jwt) throws AuthenticationException {
